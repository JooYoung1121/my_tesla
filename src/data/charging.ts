...
export const chargingApps: ChargingApp[] = [
  ...
  },
  {
    ...
    note: "공식 데이터가 '운영중'이라고 해도 실제로는 고장난 경우가 있다. 그 간극을 메우는 게 이 앱의 값어치다. 운영사는 소프트베리. 별도 홍보용 웹사이트가 없어 앱스토어로 연결한다.",
  ...
  {
    name: "모두의충전",
    role: "여러 사업자 충전기를 한 앱에서 결제하도록 묶어주는 통합 결제 앱(모두페이).",
    when: "사업자별 앱을 여러 개 깔기 싫을 때",
    note: "같은 성격의 대안으로 해피차저(happecharger.com, 한국전기차충전서비스)가 있다 — 철자가 happe로 happy가 아니다. 사업자별 지원 범위가 앱마다 다르니 생활권에 뭐가 깔려 있는지 먼저 보고 고른다.",
    url: "https://evmodu.kr/",
    weight: "보조",
    source: "커뮤니티"
  },
